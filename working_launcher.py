...
async def addpromo(m,p):
    ...
    # Cases: /addpromo CODE case CASE AMOUNT LIMIT
    ...
    try:
        ...
        cols=await db.execute("PRAGMA table_info(promos)"); existing={r[1] for r in await cols.fetchall()}
